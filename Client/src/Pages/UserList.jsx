...
class UserList extends React.Component {
  constructor(props) {
    ...
    this.setTotalCountUser = this.setTotalCountUser.bind(this);
  }
  ...
  setTotalCountUser(data) {
    const { totalCountUser } = this.state;
    if (data !== totalCountUser) {
      this.setState(() => (
        { totalCountUser: data }
      ));
    }
  ...
  getTotalCountUser() {
    client.query({
      ...
      .then((response) => {
        if (response.data) this.setTotalCountUser(response.data.getTotalCountUser);
      });
  }
                      ...
                      <label htmlFor="maxPerPage">
                        ...
                        <select
                          ...
                          onChange={event => this.onPush({
                            pageNum, maxPerPage: event.target.value, search, sort, asc,
                          })}
                        >
