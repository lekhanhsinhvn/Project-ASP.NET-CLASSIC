                          ...
                          <div className="dataTables_paginate paging_simple_numbers">
                            <ul className="pagination">
                              ...
                              <li className="paginate_button page-item">
                                {pageNum - 2 >= 0
                                  ? (<Link className="page-link" to={`/users?pageNum=${pageNum - 2}&maxPerPage=${maxPerPage}&search=${search}&sort=${sort}&asc=${asc}`}>{pageNum - 1}</Link>)
                                  : ''}
                              </li>
                              <li className="paginate_button page-item">
                                {pageNum - 1 >= 0
                                  ? (<Link className="page-link" to={`/users?pageNum=${pageNum - 1}&maxPerPage=${maxPerPage}&search=${search}&sort=${sort}&asc=${asc}`}>{pageNum}</Link>)
                                  : ''}
                              </li>
                              ...
                              <li className="paginate_button page-item">
                                {(pageNum + 1) * maxPerPage < totalCountUser
                                  ? (<Link className="page-link" to={`/users?pageNum=${pageNum + 1}&maxPerPage=${maxPerPage}&search=${search}&sort=${sort}&asc=${asc}`}>{pageNum + 2}</Link>)
                                  : ''}
                              </li>
                              <li className="paginate_button page-item">
                                {(pageNum + 2) * maxPerPage < totalCountUser
                                  ? (<Link className="page-link" to={`/users?pageNum=${pageNum + 2}&maxPerPage=${maxPerPage}&search=${search}&sort=${sort}&asc=${asc}`}>{pageNum + 3}</Link>)
                                  : ''}
                              </li>
